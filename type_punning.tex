...
void next_ulp(float& f)
{
  ...
  \iftransitions \uncover<6->{\includegraphics[height=.2\textheight]{resources/ulp_memcpy.png}} \else \includegraphics[height=.2\textheight]{resources/ulp_memcpy.png} \fi
