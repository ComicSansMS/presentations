...
\lstdefinestyle{cpp20}{language={C++},
  morekeywords={co_await,co_return,co_yield,requires,consteval,constinit,concept}
}
...
\date{Core C++ 2022}
\titlegraphic{\includegraphics[height=.15\textheight]{resources/corecpp_logo.png}}
...
(*@\tikz[baseline,inner sep=0]\node[anchor=base](nom1){};@*)FiboGenerator(*@\tikz[baseline,inner sep=0]\node[anchor=base](nom2){};@*) makeFiboGenerator();
  \end{lstlisting}
  \uncover<2->{Is \texttt{makeFiboGenerator()} a coroutine?}
  \uncover<3->{ \tikz[overlay]\filldraw[blue, opacity=0.3] (nom1) rectangle ([shift={(0,2ex)}]nom2); }
...
(*@\tikz[baseline,inner sep=0]\node[anchor=base](ar01){};@*)ReturnType(*@\tikz[baseline,inner sep=0]\node[anchor=base](br01){};@*) hello_coroutine() {
  ...
  \uncover<3->{ \tikz[overlay]\filldraw[blue, opacity=0.3] ([shift={(0,-0.5ex)}]ar01) rectangle ([shift={(0,2ex)}]br01); }
...
struct ReturnType {
  ...
  \uncover<2->{ \tikz[overlay]\filldraw[red, opacity=0.3] ([shift={(0,-0.5ex)}]ar02) rectangle ([shift={(0,2ex)}]br02); }
