...
\begin{frame}
  ...
  \item Games
    \iffalse
    \includegraphics[height=.4\textheight]{resources/mi_lua_bar.jpg}
    \includegraphics[height=.4\textheight]{resources/wow_raidui.png}
    \fi
...
\begin{frame}
  ...
  This talk is trying too hard to be clever in some places.
\end{frame}
