...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item \includegraphics[height=.05\textheight]{resources/so-icon.png} \includegraphics[height=.05\textheight]{resources/slack-icon.png} ComicSansMS on StackOverflow and Slack
    
    \item \includegraphics[height=.05\textheight]{resources/twitter-icon.png} @DerGhulbus on Twitter
    
    \item \includegraphics[height=.05\textheight]{resources/meetup-icon.png} Co-organizer of the Munich C++ User Group
