...
\begin{frame}
  ...
  \begin{columns}[t]
    ...
    \includegraphics[height=3.5cm]{resources/nodemcu_small.png}
    \column{.5\textwidth}
    \centering
    \includegraphics[height=3.5cm]{resources/wow_raidui_small.png}\\
    \includegraphics[height=3.5cm]{resources/lightroom_small.png}
  \end{columns}
